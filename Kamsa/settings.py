"""
Django settings for Kamsa project.
...
SECRET_KEY = 'django-insecure-@$sck24eq&r9c^42=r-k0e!oyta6$e-p+7nt+k)q$ivr9!wze#'
...
WSGI_APPLICATION = 'Kamsa.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'Kamsa_auto' / 'static',]
