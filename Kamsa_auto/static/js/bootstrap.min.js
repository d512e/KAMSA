...
document.addEventListener('DOMContentLoaded', function() {
  // On récupère les éléments de la page après le chargement du DOM
  ...
  // Sécurité au cas où les éléments ne sont pas sur la page actuelle
  if (!prixTotalSpan || !dateDebutInput || !dateFinInput || !chauffeurCheckbox) return;

  // Récupérer le prix par jour depuis l'attribut data-prix du span HTML
